...
// 需要返回的东西
var html = '<a id="a" href="'+__dirname+'/public/index.html">123</a>';
...
serv.listen(8090,function(){
	console.log('Node app start success at port 8090!');
});*/
...
 
  var realPath = path.join('E:/Web-test/job-app-demo/public/index.html',pathname);
  //完整的url路径
